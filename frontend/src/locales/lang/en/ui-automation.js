export default {
  ...
  element: {
    ...
    noElementScreenshot: 'No screenshot',
    primarySelector: 'Primary Selector',
    backupSelectors: 'Backup Selectors',
    addBackupSelector: 'Backup Selector',
  ...
  execution: {
    ...
    aiHealedStep: 'AI Healed',
    aiFailureReason: 'AI Failure Analysis',
    aiTempLocator: 'Temporary Locator',
    healedViaAi: 'Passed via AI Self-Healing',
  ...
  report: {
    ...
    messages: {
      ...
      batchDeleteConfirm: 'Are you sure to delete {count} selected reports? This action cannot be undone.',
      confirmDelete: 'Confirm Delete',
      deleteSuccess: 'Deleted successfully',
  ...
  ai: {
    ...
    caseFile: 'Case File',
    uploadText: 'Click or drag Excel case file here',
    uploadHint: 'Only Excel (.xlsx/.xls) supported, executed case by case',
    uploading: 'Parsing case file...',
    parsedCount: 'Parsed',
    cases: ' cases',
    caseParsed: 'Case file parsed successfully, found ',
    casePreviewTitle: 'Case File Parse Result',
    preview: 'Preview',
    remove: 'Remove',
    gifRecording: 'GIF Recording',
    project: 'Project',
    reuseLoginState: 'Reuse Login State',
    reuseLoginStateTip: 'Reuse project login state; silent re-login and refresh if expired',
    on: 'On',
    off: 'Off',
    gifTip: 'When enabled, the execution process will be recorded as a GIF file',
    startExecution: 'Start Execution',
    ...
    messages: {
      ...
      saveFailed: 'Failed to save',
      noModelConfigured: 'No available AI model configured. Please add and enable a model in "Config Center - AI Mode Config".',
      goToConfig: 'Go to Config',
      checkModelFailed: 'Failed to check model configuration, please try again later'
    },
    // AI Case List
    caseList: {
    ...
    executionRecords: {
      ...
      executionDetail: 'Execution Details',
      taskDescription: 'Task Description',
      taskSourceDetail: 'Task Source Details',
      downloadDocument: 'Download Document',
      downloadText: 'Copy Text',
      copySuccess: 'Copied successfully',
      copyFailed: 'Copy failed',
      noSourceFile: 'This record has no original case file',
  ...
  scheduledTask: {
    ...
    selectedSuiteTitle: 'Selected Test Suite',
    selectedCasesTitle: 'Selected Test Cases',
    scheduleConfig: 'Schedule Config',
    totalRuns: 'Total Runs',
    runStats: 'Success/Failed',
    runStatsValue: 'Success {success} / Failed {failed}',
    testCaseCount: '{count} case(s) selected',
    createdBy: 'Created By',
  ...
  // Playwright Script Recording
  playwrightRecording: {
    title: 'Playwright Script Recording',
    tipTitle: 'Manual recording + AI optimization',
    tipContent: 'Based on Playwright Codegen: record flows manually, then parse → test plan (confirm gate) → generate Page Objects / data factories / specs.',
    workflow: 'Flow: check env → start codegen → operate UI → parse recording → generate & confirm plan → generate engineered scripts',
    stepRecord: 'Record',
    stepParse: 'Parse',
    stepPlan: 'Test Plan',
    stepGenerate: 'Generate',
    enterPipeline: 'Continue pipeline (parse)',
    parseTitle: 'Parse Result',
    parseSteps: 'Steps',
    parsePages: 'Page candidates',
    parseCaptcha: 'Has captcha',
    parseFragile: 'Fragile selectors',
    parseParams: 'Param candidates',
    parseMissingAssert: 'Missing assertions',
    yes: 'Yes',
    no: 'No',
    nextGeneratePlan: 'Generate test plan',
    planTitle: 'Test Plan (confirmation gate)',
    planHint: 'Review the plan; pages/data/specs will not be generated before confirmation. You may edit then confirm.',
    userCases: 'User cases (optional)',
    userCasesPlaceholder: 'Paste existing case docs here; they take priority when building the plan',
    regeneratePlan: 'Regenerate plan',
    savePlan: 'Save plan',
    confirmPlan: 'Confirm plan',
    generateScripts: 'Generate engineered scripts',
    useAiEnhance: 'AI-enhanced generation',
    useAiEnhanceHint: 'Off by default: template plan/scripts in seconds; on = call AI (slower, usually < 1 min)',
    resultTitle: 'Generation Result',
    resultFiles: 'Generated files',
    resultScripts: 'Saved script IDs',
    resultPageObjects: 'Saved page object IDs',
    goToPageObjects: 'View page objects',
    finishHint: 'Scripts and scaffolds are ready. Running tests / opening reports / fixing failures requires a separate action.',
    backToRecord: 'Back to recording',
    envTitle: 'Recording Environment',
    refreshEnv: 'Recheck',
    envReady: 'Ready',
    envNotReady: 'Not ready',
    targetUrl: 'Target URL',
    targetUrlPlaceholder: 'Enter the page URL to record, e.g. https://example.com',
    scriptName: 'Script Filename',
    scriptNamePlaceholder: 'Optional, auto-generated by default, e.g. login.py',
    browser: 'Browser',
    language: 'Script Language',
    status: 'Status',
    statusIdle: 'Idle',
    statusStarting: 'Starting',
    statusRecording: 'Recording (operate in browser, then stop in Inspector)',
    statusFinished: 'Finished',
    statusStopped: 'Force stopped',
    statusFailed: 'Failed',
    startRecording: 'Start Recording',
    stopRecording: 'Force Stop',
    recordedScript: 'Recorded Script',
    scriptPlaceholder: 'Script will appear after recording finishes; you can also load from history below',
    clear: 'Clear',
    saveScript: 'Save to Script List',
    goToScriptList: 'View Script List',
    ...
    messages: {
      ...
      selectProject: 'Please select a project first',
      emptyUrl: 'Please enter a target URL',
      emptyScript: 'Please finish recording or paste a script first',
      ...
      recordFinished: 'Recording finished, script loaded',
      fileLoaded: 'Recording file loaded',
      fileLoadFailed: 'Failed to load recording file',
      parseSuccess: 'Parse completed',
      parseFailed: 'Parse failed',
      planSuccess: 'Test plan generated — please confirm',
      planFailed: 'Failed to generate plan',
      planSaved: 'Plan saved',
      planConfirmed: 'Plan confirmed',
      confirmRequired: 'Please confirm the test plan first',
      generateSuccess: 'Engineered scripts generated',
      generateFailed: 'Failed to generate scripts'
    }
  },
  ...
  script: {
    ...
    messages: {
      ...
      deleteSuccess: 'Deleted successfully',
      deleteFailed: 'Failed to delete',
      emptyContent: 'Script content is empty and cannot be run',
      runStart: 'Starting script "{name}" - {browser} / {mode}',
      runStarted: 'Script execution started (record #{id})',
      runStartedTitle: 'Execution Started',
      goToReports: 'Go to Test Reports to view the result?',
  ...
  testCase: {
    ...
    recordStepsTitle: 'Record Steps',
    recordTargetUrl: 'Target URL',
    recordTargetUrlPlaceholder: 'Enter the page URL to record, e.g. https://example.com',
    recordBrowser: 'Browser',
    recordAutoLogin: 'Reuse Login State',
    recordAutoLoginHint: 'Loads project saved login state; silently refreshes in background if expired (project credentials required)',
    recordAutoLoginNoCreds: 'Requires project/env login credentials, or a previously saved login state; target URL may be empty to use project env',
    recordStatus: 'Status',
    recordStart: 'Start Recording',
    recordStop: 'Stop Recording',
    recordPreview: 'Parsed Result ({count} steps)',
    recordAppend: 'Append to existing',
    recordReplace: 'Replace all steps',
    recordImport: 'Import Steps',
    recordScriptReady: 'Recording script ready, parsing…',
    recordStatusIdle: 'Idle',
    recordStatusStarting: 'Starting',
    ...
    headlessMode: 'Headless Mode',
    runLabel: 'Run',
    runConfig: 'Run Test Case',
    testEngine: 'Test Engine',
    browser: 'Browser',
    executionMode: 'Execution Mode',
    runTargetUrl: 'Target URL',
    runTargetUrlPlaceholder: 'Enter the page URL to open, e.g. https://example.com',
    runAutoLogin: 'Reuse Login State',
    running: 'Running...',
    ...
    expandCaseList: 'Expand case list',
    collapseCaseList: 'Collapse case list',
    exitInspect: 'Exit inspect',
    enterInspect: 'Inspect element',
    closeScreencast: 'Close screencast',
    pickPanelTitle: 'Element Picker',
    inspectModeOnly: 'Inspect only (no actions)',
    pickUrlPlaceholder: 'Page URL',
    pickGo: 'Go',
    pickLoading: 'Starting screencast (~10s)…',
    fillAllSmart: 'Fill all (smart primary)',
    uniqueMatch: 'Unique',
    matchCount: '{n} matches',
    copyLocator: 'Copy',
    fillOneLocator: 'Fill',
    fillAllTip: 'Fill all sets primary + unique backups; single fill only appends that backup',
    strategyLabel: 'Form label',
    strategyCssPath: 'CSS path',
    ...
    waitTimeout: 'Wait Timeout (seconds)',
    selector: 'Selector',
    locatorExpressionPlaceholder: 'Locator expression',
    backupSelectors: 'Backup Selectors',
    addBackupSelector: 'Add backup',
    ...
    aiFailureReason: 'AI Failure Analysis',
    aiTempLocator: 'Temporary Locator',
    usedSelector: 'Passed with',
    primarySelector: 'Primary',
    backupSelectorUsed: 'Backup',
    executionLogs: 'Execution Logs',
    failedScreenshots: 'Failed Screenshots',
    errorInfo: 'Error Info',
    noLogs: 'No execution logs',
    ...
    messages: {
      ...
      recordEnvNotReady: 'Recording environment is not ready. Please install Playwright / Node first.',
      recordEnvCheckFailed: 'Failed to check recording environment',
      recordEmptyUrl: 'Please enter a valid target URL',
      runEmptyUrl: 'Please enter a valid target URL',
      recordStarted: 'Recording started. Please operate in the opened browser.',
      recordStartFailed: 'Failed to start recording',
      recordStopped: 'Recording stopped',
      recordStopFailed: 'Failed to stop recording',
      recordFinished: 'Recording finished',
      recordEmptyScript: 'No recorded script content',
      recordNoSteps: 'No usable steps parsed. Please check the recording.',
      recordParsed: 'Parsed {count} steps',
      recordParseFailed: 'Failed to parse recording',
      recordImported: 'Imported {count} steps. Please review and save the case.',
      updateLocatorFailed: 'Failed to update element locators',
      pickStarted: 'Picker started. Click the screencast to select an element',
      screencastStarted: 'Screencast started',
      screencastNoFrame: 'Connected but no frame yet; retry or check the target site',
      pickStartFailed: 'Failed to start picker',
      pickNavigateFailed: 'Navigation failed',
      pickNoElement: 'No element picked',
      pickInspectFailed: 'Inspect failed',
      locatorCopied: 'Locator copied',
      locatorFilled: 'Primary locator filled',
      locatorBackupAdded: 'Backup locator added',
      locatorBackupExists: 'Backup locator already exists',
      locatorIsPrimary: 'This locator is already the primary',
      locatorFilledAll: 'Element created and filled {n} locators',
      pickSaveElementFailed: 'Failed to create element'
    },
