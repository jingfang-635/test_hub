export default {
  testcase: {
    ...
    aiGenerateStepsStatusGenerating: 'Generating, please wait…',
    aiGenerateStepsStatusSuccess: 'Generation completed',
    aiGenerateStepsStatusFailed: 'Generation failed',
    aiGenerateStepsReuseAuthTitle: 'Reuse the project saved login state?',
    aiGenerateStepsReuseAuthHint: '· Yes: skip login, suitable for post-login business steps<br/>· No: run full login & interactions so login steps can be recorded',
