export default {
  requirementAnalysis: {
    ...
    sourceManualDesc: '直接输入需求描述文本，快速生成测试用例',
    sourceUpload: '上传需求文档',
    sourceUploadDesc: '支持PDF、Word、TXT、Markdown格式文档解析',
    sourceKnowledge: '知识库需求',
    sourceKnowledgeDesc: '从已有的产品知识库中检索相关需求并生成测试用例',
    sourceFigma: 'Figma解析需求',
    sourceFigmaDesc: '自动解析 Figma 设计稿链接中的页面结构、文本说明和交互流程',
    sourceFeishu: '飞书文档需求',
    sourceFeishuDesc: '粘贴飞书新版文档或知识库链接，自动拉取正文并生成测试用例',
    feishuDocLink: '飞书文档链接',
    feishuLinkPlaceholder: '请输入飞书文档链接，如：https://xxx.feishu.cn/docx/xxxx 或 /wiki/xxxx',
    feishuHint: '首次使用请先「连接飞书账号」完成授权。授权后可读取你本人有权限的飞书文档/知识库。请确保飞书开发者后台的重定向 URL 与 config.yaml 中 FEISHU_REDIRECT_URI 完全一致（默认前端页 http://localhost:3000/ai-generation/requirement-analysis）。',
    feishuParsing: '解析中...',
    feishuParseSuccess: '飞书文档解析成功',
    feishuContentPreview: '文档正文（可微调后生成）',
    feishuChars: '字符',
    feishuConnect: '连接飞书账号',
    feishuConnecting: '跳转授权中...',
    feishuConnectedAs: '已连接：{name}',
    feishuDisconnect: '断开连接',
    feishuNeedConnect: '请先连接飞书账号后再解析文档',
    feishuOAuthSuccess: '飞书账号连接成功',
    feishuOAuthDenied: '已取消飞书授权',
    feishuOAuthError: '飞书授权失败',
    feishuDisconnectSuccess: '已断开飞书连接',
    feishuErrorNotConfigured: '飞书应用未配置，请在 config.yaml 设置 FEISHU_APP_ID / FEISHU_APP_SECRET / FEISHU_REDIRECT_URI',
    feishuErrorInvalidUrl: '链接无效：请使用飞书文档或知识库链接',
    feishuErrorUnsupportedUrl: '链接格式不支持：仅支持 /docx/ 与 /wiki/ 链接',
    feishuErrorPermission: '当前飞书账号无权阅读该文档，请确认文档已分享给你',
    feishuErrorWikiType: '该 Wiki 节点不是新版文档，暂不支持',
    feishuErrorEmpty: '文档正文为空，请确认文档有内容且当前账号可阅读',
    feishuErrorAuth: '飞书凭证无效，请检查 FEISHU_APP_ID / FEISHU_APP_SECRET',
    feishuErrorTooLong: '文档正文过长，请拆分文档后重试',
    feishuErrorNetwork: '飞书服务暂时不可用，请稍后重试',
    feishuErrorNeedOAuth: '尚未连接飞书账号，请先完成授权',
    feishuErrorNeedReauth: '飞书授权已过期，请重新连接飞书账号',
    selectKnowledgeBase: '选择知识库',
    selectKnowledgeBasePlaceholder: '请选择知识库',
    noKnowledgeBaseHint: '暂无可用知识库，请先在配置页创建：',
    goToKnowledgeBase: '知识库管理',
    ...
    vectorRatio: '向量检索占比',
    searchContent: '检索内容',
    searchContentPlaceholder: '请输入需要检索的需求内容',
    search: '搜索',
    figmaOnlineLink: 'Figma在线链接',
    figmaLinkPlaceholder: '请输入Figma设计稿链接，如：https://www.figma.com/design/xxxxx/FileName',
    confirmParse: '确定解析',
    figmaFullContent: '全量内容',
    figmaIncrementalContent: '增量内容',
    figmaUseAiStructure: '使用AI结构化整理需求内容',
    figmaHint: '粘贴 Figma 链接后点击解析，将自动提取设计稿文本并按当前用例生成配置生成测试用例。请先在 config.yaml 配置 FIGMA_ACCESS_TOKEN。',
    figmaParsing: '解析并生成中...',
    figmaParseSuccess: 'Figma 解析成功，开始生成测试用例',
    figmaContentPreview: '解析内容（可微调后重新生成）',
    figmaErrorNotConfigured: 'Figma 未配置，请在 config.yaml 设置 FIGMA_ACCESS_TOKEN',
    figmaErrorInvalidUrl: '链接无效：请使用 Figma 设计稿链接',
    figmaErrorUnsupportedUrl: '链接格式不支持：请使用 /design/、/file/ 或 /proto/ 链接',
    figmaErrorPermission: '无权访问该 Figma 文件，请确认 Token 权限或文件已分享',
    figmaErrorNotFound: '未找到该 Figma 文件或节点',
    figmaErrorEmpty: '未能提取到有效文本，请确认画板含文本层或批注',
    figmaErrorAuth: 'Figma Token 无效，请检查 FIGMA_ACCESS_TOKEN',
    figmaErrorTooLong: '解析内容过长，请带 node-id 缩小范围后重试',
    figmaErrorNetwork: 'Figma 服务暂时不可用，请稍后重试',
    ...
    saveToRecords: '保存到记录',
    saveToRecordsSuccess: '已保存到AI生成用例记录，请到「AI生成用例」中采纳后才会进入用例库',
  ...
  knowledgeBase: {
    title: '知识库管理',
    subtitle: '管理项目的知识库，支持文档上传，分类管理，全文搜索',
    listTitle: '知识库列表',
    addBase: '新建知识库',
    editBase: '编辑知识库',
    addFirstBase: '新建第一个知识库',
    emptyTitle: '暂无知识库',
    emptyDescription: '请先创建知识库，再上传 PDF / Word / MD / TXT 文档',
    name: '知识库名称',
    ...
    vectorConfig: '向量化配置',
    chunkSize: '分块大小',
    chunkSizeTip: '文本切分时每个分块的字符数，建议 300-800',
    chunkOverlap: '分块重叠',
    chunkOverlapTip: '相邻分块重叠的字符数，有助于保持上下文连贯',
    ...
    documents: '文档管理',
    uploadDocument: '上传文档',
    uploadHint: '支持 PDF、Word、TXT、Markdown 格式，单个文件不超过 50MB',
    dragTip: '将文件拖到此处，或点击上传',
    uploadConfirmTitle: '确认上传',
    uploadConfirm: '已选择 {count} 个文件：{names}。{action}',
    uploadConfirmVectorize: '确认后将上传并自动进行向量化处理。',
    uploadConfirmOnly: '确认后将上传文档（当前知识库未启用向量化）。',
    uploadVectorizeSuccess: '文档上传成功，已完成向量化处理',
    vectorized: '已向量化（{count}块）',
    selectFile: '选择文件',
    documentTitle: '文档标题',
    documentTitlePlaceholder: '默认使用文件名',
    fileName: '文件名',
    fileType: '类型',
    fileSize: '大小',
    status: '状态',
    ...
    enabled: '启用',
    disabled: '未启用',
    noDocuments: '暂无文档，请上传知识库文件',
    backToList: '返回',
    basicInfo: '基本信息',
    documentType: '文档类型',
    vectorStatus: '向量化状态',
    vectorCompleted: '已完成',
    vectorProcessing: '处理中',
    vectorFailed: '失败',
    vectorPending: '未向量化',
    vectorDisabled: '未启用',
    viewOriginal: '查看原文',
    ...
    recallCount: '召回数量',
    vectorRatio: '向量检索占比',
    vectorRatioTip: '混合检索中向量语义检索所占权重，剩余权重用于关键词检索',
    searchResults: '检索结果',
    searchEmpty: '未找到相关内容',
    searchComingSoon: '语义/混合检索功能正在开发中，敬请期待',
    save: '保存',
    cancel: '取消',
    saving: '保存中...',
    uploading: '上传并处理中...',
    ...
    deleteConfirm: '确定删除该知识库吗？其中的文档将一并删除。',
    deleteDocConfirm: '确定删除该文档吗？',
    deleteDocSuccess: '文档删除成功',
    uploadSuccess: '文档上传成功',
    uploadFailed: '文档上传失败',
    invalidFileType: '仅支持 PDF、Word、Markdown、TXT 格式',
    fileTooLarge: '文件大小不能超过 50MB',
    selectBaseFirst: '请先选择或创建知识库',
    extractSuccess: '文本提取完成',
