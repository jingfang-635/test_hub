export default {
  requirementAnalysis: {
    ...
    sourceAxure: 'Axure解析需求',
    sourceAxureDesc: '自动解析 Axure 原型链接中的文本说明和交互流程图',
    sourceFeishu: '飞书文档需求',
    ...
    axureLinkPlaceholder: '请输入Axure原型在线链接，如：https://tenxun-axure.tenxun.cn/xxxxx/start.html',
    confirmParse: '确定解析',
    axureFullContent: '全量内容',
    axureIncrementalContent: '增量内容',
    axureUseAiStructure: '使用AI结构化整理需求内容',
