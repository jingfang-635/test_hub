...
export default {
  ...
  interface: {
    ...
    confirmImport: '确认导入',
    finish: '完成',
    totalInterfaces: '共 {count} 个接口',
    importSuccess: '导入成功',
    importSuccessDetail: '导入成功：{collections} 个集合，{requests} 个接口',
    pleaseUploadFile: '请先上传文件',
    pleaseSelectInterfaces: '请选择要导入的接口',
    noInterfaceParsed: '未解析到可导入的接口',
    parseFailed: '解析失败',
    importFailed: '导入失败',
    ...
    extractors: '变量提取',
    addExtractor: '添加提取器',
    noExtractors: '暂无变量提取配置',
    extractorVariablePlaceholder: "{'{'}{'{'} variable_name {'}'}{'}'}",
    extractorDefaultValue: '默认值',
    extractorJsonPathPlaceholder: '$.results[0].id',
    extractorRegexPlaceholder: '"token":"([^"]+)"',
    extractorExpressionLabel: '表达式:',
    extractorResults: '提取结果',
    extractSuccess: '提取成功',
    extractFailed: '提取失败',
    usedDefaultValue: '使用默认值',
    extractorSources: {
      body: '响应体',
      headers: '响应头'
    },
    ...
    extractorHelpTitle: '使用说明',
    extractorHelpJsonPathTitle: 'JSONPath 提取',
    extractorHelpJsonPathDesc: '使用 JSONPath 表达式从 JSON 响应中提取数据：',
    extractorHelpJsonPathEx1: '提取 data 对象中的 token 字段',
    extractorHelpJsonPathEx2: '提取 items 数组第一个元素的 id 字段',
    extractorHelpJsonPathEx3: '提取 users 数组中所有元素的 name 字段',
    extractorHelpRegexTitle: '正则表达式提取',
    extractorHelpRegexDesc: '使用正则表达式从响应文本中提取数据：',
    extractorHelpRegexEx1: '提取 JSON 中的 token 值',
    extractorHelpRegexEx2: '提取 URL 参数中的数字',
    extractorHelpUsageTitle: '使用示例',
    extractorHelpUsageDesc: "在后续接口中使用 {'{'}{'{'}variable_name{'}'}{'}'} 引用提取的变量：",
    extractorHelpWorkflowTitle: '工作流示例',
    extractorHelpWorkflow1: '登录接口提取 token',
    extractorHelpWorkflow2: "后续接口在 Header 中使用 {'{'}{'{'}token{'}'}{'}'}",
    extractorHelpWorkflow3: '获取用户信息接口提取 userId',
    extractorHelpWorkflow4: "后续接口在 URL 中使用 {'{'}{'{'}userId{'}'}{'}'}",
    extractorHelpNote: '注意：变量名不能重复，后提取的值会覆盖先前提取的同名变量。选择环境后发送请求，提取结果会写入该环境变量的当前值。',
    // WebSocket
    messageType: '选择消息类型',
    ...
    responseTreeView: '树形',
    responseRawView: '原始',
    responseTreeSearch: '搜索键名或值...',
    expandAll: '全部展开',
    collapseAll: '全部折叠',
    searchResponseHeaders: '搜索响应头...',
    jsonPathQuery: '查询',
    jsonPathQueryPlaceholder: 'JSONPath查询，例如: $.data.users[0].name',
    jsonPathQueryResult: 'JSONPath查询结果',
    jsonPathHelp: '支持 $.a.b、$.items[0].id、$.users[*].name 等表达式',
    jsonPathNeedJson: '当前响应不是 JSON，无法查询',
    jsonPathEmpty: '请输入 JSONPath 表达式',
    jsonPathNoMatch: '未匹配到结果',
    jsonPathInvalid: 'JSONPath 表达式无效',
    copyJsonPathExpression: '复制 JSONPath 表达式',
  ...
  automation: {
    ...
    skipConditionHelp: '使用Python表达式，当条件为True时跳过该请求执行。示例：',
    variableExtraction: '变量提取',
    assertionConfig: '断言配置',
    add: '添加',
    syncInterfaceData: '同步接口数据',
    syncSuccess: '同步成功',
    syncFailed: '同步失败',
    syncInterfaceMissing: '未找到关联接口，无法同步',
    noSuiteExtractors: '暂无套件变量提取，可同步接口数据或单独添加',
    suiteExtractorHelp: '变量提取说明：',
    suiteExtractorHelpSync: '点击「同步接口数据」可拉取关联接口的最新变量提取配置到当前套件',
    suiteExtractorHelpAdd: '也可单独添加变量提取规则，仅对当前测试套件生效',
    suiteExtractorHelpScope: '套件内配置不会写回接口管理中的原接口',
    extractorJsonPathHint: '示例：$.data.token  $.items[0].id',
    extractorRegexHint: '示例："token":"([^"]+)"  userId=(\\d+)',
    clearAssertions: '清空断言',
    addAssertion: '添加断言',
    noSuiteAssertions: '暂无套件断言，可同步接口数据或单独添加',
    remove: '移除',
  ...
  report: {
    ...
    resultFailed: '失败',
    resultSkipped: '跳过',
    confirmDelete: '确定要删除该测试报告吗？删除后相关 Allure 报告文件也会被清理。',
    status: {
      pending: '待执行',
      running: '执行中',
      completed: '已完成',
