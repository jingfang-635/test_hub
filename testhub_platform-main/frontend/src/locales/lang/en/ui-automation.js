export default {
  ...
  testCase: {
    ...
    recordStepsTip: 'Start Playwright Codegen → operate in the opened browser → stop, parse, and import as case steps',
    ...
    recordScriptReady: 'Recording script ready. Click "Parse Recording" to preview steps.',
