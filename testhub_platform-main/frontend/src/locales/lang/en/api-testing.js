...
export default {
  ...
  interface: {
    ...
    name: 'Name',
    method: 'Method',
    importInterfaces: 'Import Interfaces',
    importFormat: 'Format',
    importFile: 'File',
    importContent: 'Content',
    dragOrClickUpload: 'Drag and drop a file here, or click to upload',
    targetProject: 'Target Project',
    parsePreview: 'Parse Preview',
    confirmImport: 'Confirm Import',
    finish: 'Done',
    totalInterfaces: '{count} interfaces in total',
    importSuccess: 'Import Successful',
    importSuccessDetail: 'Imported successfully: {collections} collections, {requests} interfaces',
    pleaseUploadFile: 'Please upload a file first',
    pleaseSelectInterfaces: 'Please select interfaces to import',
    noInterfaceParsed: 'No interfaces found in the file',
    ...
    responseTreeView: 'Tree',
    responseRawView: 'Raw',
    responseTreeSearch: 'Search key or value...',
    expandAll: 'Expand All',
    collapseAll: 'Collapse All',
    searchResponseHeaders: 'Search response headers...',
    jsonPathQuery: 'Query',
    jsonPathQueryPlaceholder: 'JSONPath query, e.g. $.data.users[0].name',
    jsonPathQueryResult: 'JSONPath Result',
    jsonPathHelp: 'Supports $.a.b, $.items[0].id, $.users[*].name, etc.',
    jsonPathNeedJson: 'Current response is not JSON',
    jsonPathEmpty: 'Please enter a JSONPath expression',
    jsonPathNoMatch: 'No match found',
    jsonPathInvalid: 'Invalid JSONPath expression',
    copyJsonPathExpression: 'Copy JSONPath expression',
    ...
    // Variable extraction
    extractors: 'Variable Extraction',
    addExtractor: 'Add Extractor',
    noExtractors: 'No extractors configured',
    extractorVariablePlaceholder: "{'{'}{'{'} variable_name {'}'}{'}'}",
    extractorDefaultValue: 'Default',
    extractorJsonPathPlaceholder: '$.results[0].id',
    extractorRegexPlaceholder: '"token":"([^"]+)"',
    extractorExpressionLabel: 'Expression:',
    extractorResults: 'Extraction Results',
    extractSuccess: 'Extracted',
    extractFailed: 'Failed',
    usedDefaultValue: 'Default used',
    extractorSources: {
      body: 'Response Body',
    ...
    extractorHelpTitle: 'Usage Guide',
    extractorHelpJsonPathTitle: 'JSONPath Extraction',
    extractorHelpJsonPathDesc: 'Use JSONPath expressions to extract data from JSON responses:',
    extractorHelpJsonPathEx1: 'Extract the token field from the data object',
    extractorHelpJsonPathEx2: 'Extract the id of the first item in the items array',
    extractorHelpJsonPathEx3: 'Extract the name field of all elements in the users array',
    extractorHelpRegexTitle: 'Regular Expression Extraction',
    extractorHelpRegexDesc: 'Use regular expressions to extract data from response text:',
    extractorHelpRegexEx1: 'Extract the token value from JSON text',
    extractorHelpRegexEx2: 'Extract digits from a URL parameter',
    extractorHelpUsageTitle: 'Usage Examples',
    extractorHelpUsageDesc: "Reference extracted variables in subsequent requests with {'{'}{'{'}variable_name{'}'}{'}'}:",
    extractorHelpWorkflowTitle: 'Workflow Example',
    extractorHelpWorkflow1: 'Extract token from the login request',
    extractorHelpWorkflow2: "Use {'{'}{'{'}token{'}'}{'}'} in the Header of later requests",
    extractorHelpWorkflow3: 'Extract userId from the user profile request',
    extractorHelpWorkflow4: "Use {'{'}{'{'}userId{'}'}{'}'} in the URL of later requests",
    extractorHelpNote: 'Note: Variable names must be unique. Later extractions overwrite earlier ones with the same name. When an environment is selected, extracted values are written to that environment variable current value.',
    // Context Menu
    contextMenu: {
      addRequest: 'Add Request',
      addSubCollection: 'Add Sub-collection',
  ...
  automation: {
    ...
    skipConditionHelp: 'Use a Python expression. The request is skipped when the condition is True. Examples:',
    variableExtraction: 'Variable Extraction',
    assertionConfig: 'Assertion Configuration',
    add: 'Add',
    syncInterfaceData: 'Sync from Interface',
    syncSuccess: 'Synced successfully',
    syncFailed: 'Sync failed',
    syncInterfaceMissing: 'Linked interface not found',
    noSuiteExtractors: 'No suite extractors yet. Sync from interface or add manually.',
    suiteExtractorHelp: 'About variable extraction:',
    suiteExtractorHelpSync: 'Click "Sync from Interface" to pull the latest extractors from the linked interface into this suite',
    suiteExtractorHelpAdd: 'You can also add extractors manually; they only apply to the current suite',
    suiteExtractorHelpScope: 'Suite-level extractors are not written back to the original interface',
    extractorJsonPathHint: 'Examples: $.data.token  $.items[0].id',
    extractorRegexHint: 'Examples: "token":"([^"]+)"  userId=(\\d+)',
    clearAssertions: 'Clear Assertions',
    addAssertion: 'Add Assertion',
    noSuiteAssertions: 'No suite assertions yet. Sync from interface or add manually.',
    remove: 'Remove',
    ...
    viewAllureReport: 'View Allure Report',
    passRate: 'Pass Rate',
    method: 'Method',
    result: 'Result',
    refresh: 'Refresh',
  ...
  report: {
    ...
    confirmDelete: 'Delete this test report? Related Allure report files will also be removed.',
    status: {
      pending: 'Pending',
      running: 'Running',
      completed: 'Completed',
