export default {
  requirementAnalysis: {
    ...
    sourceAxure: 'Axure Analysis',
    sourceAxureDesc: 'Automatically parse text notes and interaction flows from Axure prototype links',
    ...
    axureLinkPlaceholder: 'Enter Axure prototype URL, e.g. https://tenxun-axure.tenxun.cn/xxxxx/start.html',
    confirmParse: 'Confirm Parse',
    axureFullContent: 'Full Content',
    axureIncrementalContent: 'Incremental Content',
    axureUseAiStructure: 'Use AI to structure requirement content',
