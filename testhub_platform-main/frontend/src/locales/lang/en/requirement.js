export default {
  requirementAnalysis: {
    ...
    sourceManualDesc: 'Enter requirement text directly to generate test cases quickly',
    sourceUpload: 'Upload Requirement Document',
    sourceUploadDesc: 'Supports PDF, Word, TXT, and Markdown document parsing',
    sourceKnowledge: 'Knowledge Base',
    sourceKnowledgeDesc: 'Retrieve related requirements from the product knowledge base and generate test cases',
    sourceFigma: 'Figma Analysis',
    sourceFigmaDesc: 'Automatically parse page structure, text notes and interaction flows from Figma design links',
    sourceFeishu: 'Feishu Document',
    sourceFeishuDesc: 'Paste a Feishu docx or wiki link to fetch content and generate test cases',
    feishuDocLink: 'Feishu Document Link',
    feishuLinkPlaceholder: 'Enter Feishu URL, e.g. https://xxx.feishu.cn/docx/xxxx or /wiki/xxxx',
    feishuHint: 'Connect your Feishu account once, then read docs you already have access to. Ensure the Feishu redirect URL matches FEISHU_REDIRECT_URI in config.yaml (default: http://localhost:3000/ai-generation/requirement-analysis).',
    feishuParsing: 'Parsing...',
    feishuParseSuccess: 'Feishu document parsed successfully',
    feishuContentPreview: 'Document content (editable before generation)',
    feishuChars: 'chars',
    feishuConnect: 'Connect Feishu',
    feishuConnecting: 'Redirecting...',
    feishuConnectedAs: 'Connected: {name}',
    feishuDisconnect: 'Disconnect',
    feishuNeedConnect: 'Connect your Feishu account before parsing',
    feishuOAuthSuccess: 'Feishu account connected',
    feishuOAuthDenied: 'Feishu authorization cancelled',
    feishuOAuthError: 'Feishu authorization failed',
    feishuDisconnectSuccess: 'Feishu disconnected',
    feishuErrorNotConfigured: 'Feishu app is not configured. Set FEISHU_APP_ID / FEISHU_APP_SECRET / FEISHU_REDIRECT_URI.',
    feishuErrorInvalidUrl: 'Invalid link. Please use a Feishu document or wiki URL.',
    feishuErrorUnsupportedUrl: 'Unsupported URL. Only /docx/ and /wiki/ links are supported.',
    feishuErrorPermission: 'Your Feishu account cannot read this document. Ask the owner to share it with you.',
    feishuErrorWikiType: 'This wiki node is not a docx document and is not supported.',
    feishuErrorEmpty: 'Document content is empty. Ensure the doc has text and you can read it.',
    feishuErrorAuth: 'Invalid Feishu credentials. Check FEISHU_APP_ID / FEISHU_APP_SECRET.',
    feishuErrorTooLong: 'Document content is too long. Please split the document and retry.',
    feishuErrorNetwork: 'Feishu service is temporarily unavailable. Please retry later.',
    feishuErrorNeedOAuth: 'Feishu account is not connected. Please authorize first.',
    feishuErrorNeedReauth: 'Feishu authorization expired. Please reconnect.',
    selectKnowledgeBase: 'Select Knowledge Base',
    selectKnowledgeBasePlaceholder: 'Please select a knowledge base',
    noKnowledgeBaseHint: 'No knowledge base available. Create one in configuration: ',
    goToKnowledgeBase: 'Knowledge Base',
    ...
    searchContentPlaceholder: 'Enter the requirement content to search',
    search: 'Search',
    figmaOnlineLink: 'Figma Online Link',
    figmaLinkPlaceholder: 'Enter Figma design URL, e.g. https://www.figma.com/design/xxxxx/FileName',
    confirmParse: 'Confirm Parse',
    figmaFullContent: 'Full Content',
    figmaIncrementalContent: 'Incremental Content',
    figmaUseAiStructure: 'Use AI to structure requirement content',
    figmaHint: 'Paste a Figma link and parse: text is extracted and test cases are generated using the active generation config. Set FIGMA_ACCESS_TOKEN in config.yaml first.',
    figmaParsing: 'Parsing & generating...',
    figmaParseSuccess: 'Figma parsed successfully. Generating test cases...',
    figmaContentPreview: 'Parsed content (editable before re-generate)',
    figmaErrorNotConfigured: 'Figma is not configured. Set FIGMA_ACCESS_TOKEN in config.yaml.',
    figmaErrorInvalidUrl: 'Invalid link. Please use a Figma design URL.',
    figmaErrorUnsupportedUrl: 'Unsupported URL. Use /design/, /file/, or /proto/ links.',
    figmaErrorPermission: 'No access to this Figma file. Check token permissions or sharing.',
    figmaErrorNotFound: 'Figma file or node not found.',
    figmaErrorEmpty: 'No usable text found. Ensure frames have text layers or comments.',
    figmaErrorAuth: 'Invalid Figma token. Check FIGMA_ACCESS_TOKEN.',
    figmaErrorTooLong: 'Parsed content is too long. Retry with a node-id to narrow scope.',
    figmaErrorNetwork: 'Figma service is temporarily unavailable. Please retry later.',
    featureComingSoon: 'This feature is under development. Stay tuned.',

    // Manual Input
    manualInputTitle: 'Manual Requirement Input',
    ...
    saveToRecordsSuccess: 'Saved to AI generation records. Adopt cases in "AI Generated Cases" to add them to the library.',
  ...
  knowledgeBase: {
    ...
    subtitle: 'Manage project knowledge bases with document upload, categories, and full-text search',
    listTitle: 'Knowledge Bases',
    addBase: 'New Knowledge Base',
    editBase: 'Edit Knowledge Base',
    addFirstBase: 'Create First Knowledge Base',
    emptyTitle: 'No Knowledge Base',
    emptyDescription: 'Create a knowledge base first, then upload PDF / Word / MD / TXT documents',
    name: 'Name',
    ...
    vectorConfig: 'Vectorization',
    chunkSize: 'Chunk Size',
    chunkSizeTip: 'Characters per chunk when splitting text. Recommended: 300-800',
    chunkOverlap: 'Chunk Overlap',
    chunkOverlapTip: 'Overlapping characters between adjacent chunks for context continuity',
    enableVectorization: 'Vectorize',
    yes: 'Yes',
    no: 'No',
    enableThis: 'Enable this knowledge base',
    totalCount: 'Total Knowledge Bases',
    ...
    uploadHint: 'Supports PDF, Word, TXT, Markdown. Max 50MB per file.',
    dragTip: 'Drop files here, or click to upload',
    uploadConfirmTitle: 'Confirm Upload',
    uploadConfirm: '{count} file(s) selected: {names}. {action}',
    uploadConfirmVectorize: 'After confirmation, files will be uploaded and vectorized automatically.',
    uploadConfirmOnly: 'After confirmation, files will be uploaded (vectorization is disabled for this knowledge base).',
    uploadVectorizeSuccess: 'Documents uploaded and vectorized successfully',
    vectorized: 'Vectorized ({count} chunks)',
    selectFile: 'Select File',
    documentTitle: 'Document Title',
    documentTitlePlaceholder: 'Defaults to file name',
    fileName: 'File Name',
    fileType: 'Type',
    fileSize: 'Size',
    status: 'Status',
    ...
    enabled: 'Enabled',
    disabled: 'Disabled',
    noDocuments: 'No documents yet. Please upload files.',
    backToList: 'Back',
    basicInfo: 'Basic Info',
    documentType: 'Document Type',
    vectorStatus: 'Vectorization Status',
    vectorCompleted: 'Completed',
    vectorProcessing: 'Processing',
    vectorFailed: 'Failed',
    vectorPending: 'Not Vectorized',
    ...
    recallCount: 'Recall Count',
    vectorRatio: 'Vector Search Ratio',
    vectorRatioTip: 'Weight of vector semantic search in hybrid mode; the rest goes to keyword search',
    searchResults: 'Search Results',
    searchEmpty: 'No matching content found',
    searchComingSoon: 'Semantic/hybrid search is under development',
    save: 'Save',
    cancel: 'Cancel',
    saving: 'Saving...',
    uploading: 'Uploading and processing...',
    extractPreview: 'Text Preview',
    close: 'Close',
    ...
    invalidFileType: 'Only PDF, Word, Markdown, and TXT are supported',
    fileTooLarge: 'File size cannot exceed 50MB',
    selectBaseFirst: 'Please select or create a knowledge base first',
    extractSuccess: 'Text extracted',
