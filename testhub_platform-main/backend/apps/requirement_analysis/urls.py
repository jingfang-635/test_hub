...
router.register(r'knowledge-documents', KnowledgeDocumentViewSet, basename='knowledgedocument')
router.register(r'knowledge-llm-config', KnowledgeBaseLLMConfigViewSet, basename='knowledgebasellmconfig')
