...
class VersionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Version
        fields = ['id', 'name', 'description', 'is_baseline', 'status', 'projects', 'created_by', 'owner', 'created_at', 'testcases_count']
...
class VersionCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Version
        fields = ['name', 'description', 'is_baseline', 'status', 'project_ids', 'owner']
