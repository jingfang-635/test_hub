...
class TestCaseStep(models.Model):
    ...
    action_type = models.CharField(max_length=20, choices=ACTION_TYPE_CHOICES, verbose_name='操作类型')
    page_filter = models.CharField(max_length=200, blank=True, default='', verbose_name='页面筛选')
...
class UiScheduledTask(models.Model):
    ...
    # 基于 Cron 的预设触发器类型
    CRON_BASED_TRIGGER_TYPES = {'CRON', 'HOURLY', 'DAILY', 'WEEKLY', 'MONTHLY', 'YEARLY'}
    ...
    def calculate_next_run(self):
        ...
        if self.trigger_type in self.CRON_BASED_TRIGGER_TYPES and self.cron_expression:
            try:
